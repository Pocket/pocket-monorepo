...
GRANT SELECT, INSERT, UPDATE, DELETE ON `readitla_ril-tmp`.push_tokens TO pkt_inssync_w@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON `readitla_ril-tmp`.users_tokens TO pkt_inssync_w@'%';
