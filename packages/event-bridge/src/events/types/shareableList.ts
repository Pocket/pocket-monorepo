...
export const ShareableListPocketEventTypeEnum = {
  SHAREABLE_LIST_CREATED: PocketEventType.SHAREABLE_LIST_CREATED,
  SHAREABLE_LIST_UPDATED: PocketEventType.SHAREABLE_LIST_UPDATED,
  SHAREABLE_LIST_DELETED: PocketEventType.SHAREABLE_LIST_DELETED,
  SHAREABLE_LIST_HIDDEN: PocketEventType.SHAREABLE_LIST_HIDDEN,
  SHAREABLE_LIST_UNHIDDEN: PocketEventType.SHAREABLE_LIST_UNHIDDEN,
  SHAREABLE_LIST_PUBLISHED: PocketEventType.SHAREABLE_LIST_PUBLISHED,
  SHAREABLE_LIST_UNPUBLISHED: PocketEventType.SHAREABLE_LIST_UNPUBLISHED,
} as const;
...
export const ShareableListItemPocketEventTypeEnum = {
  SHAREABLE_LIST_ITEM_CREATED: PocketEventType.SHAREABLE_LIST_ITEM_CREATED,
  SHAREABLE_LIST_ITEM_UPDATED: PocketEventType.SHAREABLE_LIST_ITEM_UPDATED,
  SHAREABLE_LIST_ITEM_DELETED: PocketEventType.SHAREABLE_LIST_ITEM_DELETED,
} as const;
